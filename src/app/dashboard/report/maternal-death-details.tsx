...
export default function MaternalDeathDetailsScreen() {
  ...
  const getConditionLabel = () => {
    switch (data.death_condition?.toLowerCase()) {
      case "pregnant":
        return t("maternal_death_modal.pregnant");
      case "labor":
        return t("maternal_death_modal.labor");
      case "post_delivery":
        return t("maternal_death_modal.postpartum");
      default:
        return data.death_condition_other || "-";
    }
  };
  ...
  const getDeliveryPlaceLabel = () => {
    switch (data.delivery_place?.toLowerCase()) {
      case "home":
        return t("maternal_death_modal.home");
      case "institution":
        return t("maternal_death_modal.institution");
      case "other":
        return data.delivery_place_other || t("maternal_death_modal.other");
      default:
        return "-";
    }
  };
  ...
  const getDeathPlaceLabel = () => {
    switch (data.death_place?.toLowerCase()) {
      ...
      case "institution":
        return t("maternal_death_modal.institution");
      case "other":
        return data.death_place_other || t("maternal_death_modal.other");
      default:
        return "-";
    }
  };
      ...
      >
          ...
          <View className="flex-1">
            ...
            <View className="flex-row items-center mt-1">
              ...
              <Text className="text-slate-700 font-bold text-[14px]">
                {calculateAge(motherData?.date_of_birth) ||
                  data.mother_age ||
                  "-"}{" "}
                yrs
              </Text>
        ...
        {!!data.remarks && (
          <View className="mx-4 bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <View className="p-5">
              <Text className="text-slate-600 text-[14px] leading-relaxed">
                {data.remarks}
              </Text>
            </View>
          </View>
