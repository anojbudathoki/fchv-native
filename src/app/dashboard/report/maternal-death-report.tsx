...
export default function MaternalDeathReportScreen() {
  ...
  const handleDownload = async () => {
    ...
    try {
      const headers = [
        t("reports.common.sn"),
        t("reports.maternal_death_report.deceased_name"),
        t("reports.maternal_death_report.age"),
        t("reports.maternal_death_report.pregnant"),
        t("reports.maternal_death_report.labor"),
        t("reports.maternal_death_report.postpartum"),
        t("reports.maternal_death_report.day"),
        t("reports.maternal_death_report.month"),
        t("reports.maternal_death_report.year"),
        `Birth:${t("reports.maternal_death_report.home")}`,
        `Birth:${t("reports.maternal_death_report.facility")}`,
        `Birth:${t("reports.maternal_death_report.other")}`,
        `Death:${t("reports.maternal_death_report.home")}`,
        `Death:${t("reports.maternal_death_report.facility")}`,
        `Death:${t("reports.maternal_death_report.other")}`,
      ...
      <View className="flex-1">
        ...
        <View className="flex-row px-4 py-3 gap-3 bg-white border-b border-gray-100">
          <View className="flex-1 flex-row items-center bg-slate-50 px-4 py-2 rounded-2xl border border-slate-100">
            ...
            <Text className="ml-2 text-slate-400 font-bold text-[10px] uppercase tracking-widest">
