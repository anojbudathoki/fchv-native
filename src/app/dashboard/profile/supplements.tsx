        ...
        <View className="bg-white p-5 rounded-xl border border-slate-100">
          ...
          <View className="gap-y-3">
            {[
              ...
              <View
                key={idx}
                className="flex-row items-center justify-between p-4 bg-slate-50 rounded-md border border-slate-100/50"
              >
                <View className="flex-row items-center flex-1 pr-4 gap-2">
                  ...
                  />
                  <Text
                    className={`font-bold text-[13px] leading-snug ${item.val ? "text-emerald-800" : "text-slate-700"}`}
                  >
                    {item.label}
                  </Text>
                </View>
