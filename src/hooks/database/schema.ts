...
CREATE TABLE IF NOT EXISTS counseling_referral (
    ...
    UNIQUE(mother, pregnancy, reg_year, reg_month)
);
CREATE INDEX IF NOT EXISTS idx_counseling_referral_mother ON counseling_referral(mother);
...
CREATE TABLE IF NOT EXISTS child_counseling (
    ...
    UNIQUE(child, reg_year, reg_month)
);
